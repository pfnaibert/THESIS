...
show the $p$-values for the differences in the Mean, Log-Variance, and Sharpe Ratio of the raw portfolio returns of the Brazilian dataset using the methodology developed in \citeonline{lw2008, lw2011, lw2018}.
...
\red{with that said we only evaluate the $p$-value tables of the net return portfolios}.
...
% % RPS
% \input{../03-it-featsel/TABS/pval-mu-rps-ibov.tex}
% \input{../03-it-featsel/TABS/pval-var-rps-ibov.tex}
% \input{../03-it-featsel/TABS/pval-sr-rps-ibov.tex}
...
%   % RPS
%   \input{../03-it-featsel/TABS/pval-mu-rps-spy5.tex}
%   \input{../03-it-featsel/TABS/pval-var-rps-spy5.tex}
%   \input{../03-it-featsel/TABS/pval-sr-rps-spy5.tex}
